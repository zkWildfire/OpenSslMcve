...
bugfix patch. Then, re-run `build.bat` to rebuild the app. The bug should no
longer be reproduced when running the app. This bug fix was verified both via
Intel's SDE as well as by running the app on a Tiger Lake CPU on which the bug
occurs.
